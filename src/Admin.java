...
public class Admin extends JFrame {
	...
	public Admin() {
		...
		tabbedPane.addTab("Create Another Admin Account", null, panel, null);
		panel.setLayout(null);
		
		JLabel lblSignUpHere = new JLabel("Sign Up Here!");
		lblSignUpHere.setFont(new Font("Vodafone Rg", Font.BOLD, 16));
		lblSignUpHere.setBounds(682, 64, 178, 40);
		panel.add(lblSignUpHere);
		
		JLabel lblNewLabel_1_2 = new JLabel("First Name");
		lblNewLabel_1_2.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2.setBounds(680, 143, 109, 23);
		panel.add(lblNewLabel_1_2);
		
		textFieldfName = new JTextField();
		textFieldfName.setColumns(10);
		textFieldfName.setBounds(680, 192, 221, 20);
		panel.add(textFieldfName);
		
		JLabel lblNewLabel_1_2_1 = new JLabel("Last Name");
		lblNewLabel_1_2_1.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_1.setBounds(680, 247, 109, 23);
		panel.add(lblNewLabel_1_2_1);
		
		textFieldLName = new JTextField();
		textFieldLName.setColumns(10);
		textFieldLName.setBounds(680, 296, 221, 20);
		panel.add(textFieldLName);
		
		JLabel lblNewLabel_1_2_2 = new JLabel("Username");
		lblNewLabel_1_2_2.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_2.setBounds(680, 348, 109, 23);
		panel.add(lblNewLabel_1_2_2);
		
		textFieldUn = new JTextField();
		textFieldUn.setColumns(10);
		textFieldUn.setBounds(680, 397, 221, 20);
		panel.add(textFieldUn);
		
		JLabel lblNewLabel_1_2_3 = new JLabel("Password");
		lblNewLabel_1_2_3.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_3.setBounds(682, 447, 109, 23);
		panel.add(lblNewLabel_1_2_3);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(682, 496, 221, 20);
		...
		btnCreateAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query3 = " CREATE TABLE '"+ textFieldUn.getText() +"' (\r\n"
							+ "	\"Full Name\"	TEXT,\r\n"
							+ "	\"Student Number\"	TEXT,\r\n"
							+ "	\"Username\"	TEXT,\r\n"
							+ "	\"Password\"	TEXT\r\n"
					...
					pst3.execute();	
					pst3.close();
					String query4 = " INSERT INTO '"+ textFieldUn.getText() +"' \r\n"
							+ "(\"Full Name\", \"Student Number\", \"Username\", \"Password\")\r\n"
							+ "VALUES (?, ?, ?, ?); ";
					PreparedStatement pst4 = connection1.prepareStatement(query4);
					pst4.setString(1, textFieldfName.getText());
					pst4.setString(2, textFieldLName.getText());
					pst4.setString(3, textFieldUn.getText());
					pst4.setString(4, textField_1.getText());
					pst4.execute();	
		...
		btnCreateAccount.setFont(new Font("Verdana", Font.BOLD, 14));
		btnCreateAccount.setBackground(new Color(0, 255, 255));
		btnCreateAccount.setBounds(682, 568, 221, 23);
		panel.add(btnCreateAccount);
		
		JSeparator separator = new JSeparator();
		separator.setOrientation(SwingConstants.VERTICAL);
		separator.setBounds(481, 73, 2, 545);
		panel.add(separator);
		
		JPanel panel_1 = new JPanel();
		tabbedPane.addTab("Create Teacher Account", null, panel_1, null);
		panel_1.setLayout(null);
		
		JLabel lblCreateAnAccount = new JLabel("Create an account for a Teacher Here!");
		lblCreateAnAccount.setFont(new Font("Vodafone Rg", Font.BOLD, 16));
		lblCreateAnAccount.setBounds(295, 11, 301, 40);
		panel_1.add(lblCreateAnAccount);
		
		JLabel lblNewLabel_1_2_4 = new JLabel("First Name");
		lblNewLabel_1_2_4.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_4.setBounds(293, 90, 109, 23);
		panel_1.add(lblNewLabel_1_2_4);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(293, 139, 221, 20);
		panel_1.add(textField_2);
		
		JLabel lblNewLabel_1_2_1_1 = new JLabel("Last Name");
		lblNewLabel_1_2_1_1.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_1_1.setBounds(293, 194, 109, 23);
		panel_1.add(lblNewLabel_1_2_1_1);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(293, 243, 221, 20);
		panel_1.add(textField_3);
		
		JLabel lblNewLabel_1_2_2_1 = new JLabel("Username");
		lblNewLabel_1_2_2_1.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_2_1.setBounds(293, 295, 109, 23);
		panel_1.add(lblNewLabel_1_2_2_1);
		
		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(293, 344, 221, 20);
		panel_1.add(textField_4);
		
		JLabel lblNewLabel_1_2_3_1 = new JLabel("Password");
		lblNewLabel_1_2_3_1.setFont(new Font("Vodafone Lt", Font.BOLD, 13));
		lblNewLabel_1_2_3_1.setBounds(293, 401, 109, 23);
		panel_1.add(lblNewLabel_1_2_3_1);
		
		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(293, 450, 221, 20);
		...
		btnCreateAccount_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					pst2.setString(2, textField_3.getText());
					pst2.setString(3, textField_4.getText());
					pst2.setString(4, textField_5.getText());
					pst2.execute();	
					JOptionPane.showMessageDialog(null, "Teacher Account Created");
					pst2.close();
		...
		btnCreateAccount_1.setForeground(Color.WHITE);
		btnCreateAccount_1.setFont(new Font("Verdana", Font.BOLD, 14));
		btnCreateAccount_1.setBackground(Color.CYAN);
		btnCreateAccount_1.setBounds(293, 522, 221, 23);
